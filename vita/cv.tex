...
{\bf University of Chicago Booth School of Business} & ~~~~~~~~~~~~~~~~~~~~~~~~~~~~{\tt taddylab.github.io}
\end{tabular}
...
\vspace{-0.2cm}
M. Gentzkow, J. Shapiro, and M. Taddy.  Measuring polarization in high dimensional data. 
...
\vskip -.15cm
{\sc 2013 NBER Econometrics lectures}; a two day course with\\
...
~~{\sf\small dynaTree}: {\it Sequential inference for dynamic treed regression and classification}
, with R.B. Gramacy
\vskip -.35cm

~~{\sf\small Bmix}:
{\it Sampling algorithms for (dynamic) stick-breaking mixtures}
\vskip -.35cm
...
\vskip -.25cm
Contributor to the {\sf \small gensim} python library for natural language processing.

\medskip
\section{\bf EDITORIAL\\AND\\ADVISORY\\SERVICE}

Academic Board member for Research Computing at the University of Chicago, 2014+
\vskip -.3cm
...
\section{\bf INVITED\\ AND \\REFEREED\\ TALKS}
